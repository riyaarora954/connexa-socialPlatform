...
import { createPost, postComment } from "@/config/redux/action/postAction";
import {
  deletePost,
  incrementPostLike,
                      ...
                      <div
                        ...
                        onClick={() => {
                          ...
                          if (navigator.share) {
                            ...
                            const url =
                              encodeURIComponent("https://connexa.in");
            ...
            >
              ...
              >
                ...
                {postState.comments.length !== 0 && (
                  <div className={styles.commentAreaScrollable}>
                    <h2>Comments</h2>
